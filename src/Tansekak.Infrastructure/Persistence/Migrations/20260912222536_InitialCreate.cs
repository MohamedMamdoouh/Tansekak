        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImportedCount = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Track = table.Column<byte>(type: "tinyint", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Universities_Governorates_GovernorateId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdmissionCutoffs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdmissionCutoffs_AdmissionYears_AdmissionYearId",
                        column: x => x.AdmissionYearId,
                        principalTable: "AdmissionYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AdmissionCutoffs_UniversityFaculties_UniversityFacultyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdmissionCutoffs_AdmissionYearId_UniversityFacultyId_Track",
                table: "AdmissionCutoffs",
                columns: new[] { "AdmissionYearId", "UniversityFacultyId", "Track" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AdmissionCutoffs_Track",
                table: "AdmissionCutoffs",
                column: "Track");

            migrationBuilder.CreateIndex(
                name: "IX_AdmissionCutoffs_UniversityFacultyId",
                table: "AdmissionCutoffs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UniversityFaculties_UniversityId_FacultyId",
                table: "UniversityFaculties",
