# Tansekak — Original PRD (archived)
...
This file is the original product requirements document. The shipped product diverges in architecture, tracks, result categories, import formats, data model, and admin UI.

**Current-stage docs:** [README.md](../README.md) · [PRD.md](PRD.md) · [API.md](API.md) · [IMPORT.md](IMPORT.md)

If this file conflicts with the implementation or the current docs, the implementation and current docs win.

The remainder of this file is the **original** specification, preserved for history.
...
This archived specification is **not** the source of truth.

If this document conflicts with the implementation or with [README.md](../README.md) / [PRD.md](PRD.md), follow the implementation and current docs.
