...
export const PROFILE = {
  name: 'محمد ممدوح',
  title: 'مطور ويب · مصمم تنسيقك',
  bio:
    'حاصل على بكالوريوس هندسة — قسم هندسة الحاسبات والمنظومات. ' +
    'مهتم بتطوير مواقع الويب، وصممت تنسيقك لمساعدة طلاب الثانوية العامة على فهم خياراتهم وتوقع كلياتهم بسهولة.',
