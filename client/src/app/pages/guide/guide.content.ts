...
export const GUIDE_FAQ_ITEMS: GuideItem[] = [
  ...
  {
    question: 'ايه الفرق بين علمي علوم وعلمي رياضة وأدبي؟',
    answer:
      'كل شعبة ليها كلياتها:' +
      '<ul>' +
      '<li><strong>علمي علوم:</strong> طب، صيدلة، تمريض، أسنان، علوم…</li>' +
      '<li><strong>علمي رياضة:</strong> هندسة، حاسبات، ذكاء اصطناعي…</li>' +
      '<li><strong>أدبي:</strong> آداب، حقوق، إعلام، تربية، ألسن…</li>' +
      '</ul>' +
