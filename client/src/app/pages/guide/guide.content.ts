...
export const ENROLLMENT_STEPS: GuideStep[] = [
  ...
  {
    title: 'سلم الأوراق وادفع المصاريف',
    description:
  ...
  },
  {
    ...
    description:
      'كليات الطب والصيدلة والتمريض والأسنان غالبا بتطلب كشف طبي. اسأل الكلية عن المكان والموعد.',
  },
  {
...
export const PREPARATION_STEPS: GuideStep[] = [
  {
    title: 'اعرف مجموعك وشعبتك',
    description:
      'من نتيجة الثانوية — مجموعك الكلي وشعبتك (الشعبة العلمية أو الشعبة الأدبية) هما أساس التنسيق.',
  },
  {
...
export const GUIDE_FAQ_ITEMS: GuideItem[] = [
  ...
  },
  {
    ...
    answer:
      'الموضوع بسيط:' +
      '<ol>' +
      '<li>بتكتب مجموعك وشعبتك (الشعبة العلمية أو الشعبة الأدبية).</li>' +
  ...
  },
  {
    ...
    answer:
      '<p><strong>آه.</strong> كليات الطب والصيدلة والتمريض والأسنان وغيرها غالبا بتطلب كشف طبي.</p>' +
  ...
  },
  {
    ...
    answer:
      ...
      '<li>لو ما دخلتش برضو، في <strong>مرحلة تالتة</strong> — غالبا كليات في محافظات بعيدة أو مسائي.</li>' +
  ...
  },
  {
    ...
    answer:
      ...
      '<p>رتبهم حسب الأولوية: حط اللي في قلبك في الأول سواء كلية أو معهد. ' +
  ...
  },
  {
    ...
    answer:
      ...
      '<li>رتب الرغبات من الأهم للأقل — الأولى هي اللي هتدخلها لو مجموعك يسمح.</li>' +
      '<li>راجع كل رغبة — الاسم، المحافظة، انتساب ولا مسائي.</li>' +
      '<li>اسأل حد فاهم (معلم، مرشد) لو محتار.</li>' +
      '</ol>' +
      '<p><strong>تذكر:</strong> بعد التأكيد مفيش تعديل في نفس المرحلة.</p>',
  },
  {
  ...
  },
  {
    ...
    answer:
      ...
      '<ul>' +
      '<li>لو الكلية ظهرتلك، يبقى مجموعك أكبر من أو يساوي الحد الأدنى.</li>' +
      '<li>لو مش ظاهرة، يبقى مجموعك أقل من الحد الأدنى للقبول.</li>' +
      '</ul>' +
      '<p>ده توقع مش نتيجة رسمية — بس بيساعدك تخطط رغباتك بذكاء.</p>',
  },
  {
    question: 'ايه الفرق بين الشعبة العلمية والشعبة الأدبية؟',
    answer:
      'كل شعبة ليها كلياتها:' +
      '<ul>' +
      '<li><strong>الشعبة العلمية:</strong> طب، صيدلة، هندسة، حاسبات، تمريض، أسنان…</li>' +
      '<li><strong>الشعبة الأدبية:</strong> آداب، حقوق، إعلام، تربية، ألسن…</li>' +
      '</ul>' +
      '<p>اختار شعبتك صح عشان تشوف الكليات المتاحة لمجموعك.</p>',
  },
  {
    ...
    answer:
      ...
      '<li>جرب «نسيت كلمة السر» على الموقع الرسمي برقم الجلوس.</li>' +
      '</ul>' +
