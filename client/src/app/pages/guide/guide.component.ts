  ...
  template: `
    <div class="container">
      ...
      <section class="page-section">
        ...
        <p class="section-subtitle">
          بعد ما تظهرلك نتيجة التنسيق الرسمية، اتبع الخطوات دي عشان تكمل
          تسجيلك في الكلية.
        </p>
        ...
        <div class="guide-note">
          ...
          دايما راجع إعلان الكلية على موقع التنسيق الإلكتروني الرسمي أو صفحة
          الكلية قبل ما تروح.
        </div>
      </section>
      ...
      <section class="page-section">
        ...
        <p class="section-subtitle">
          خطوات سريعة تخليك تدخل التنسيق وانت جاهز ومخطط صح.
        </p>
        <div class="grid grid-3 guide-steps-grid">
